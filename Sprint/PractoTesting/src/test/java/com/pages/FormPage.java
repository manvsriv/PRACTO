...
public class FormPage extends BasePage{
	...
	@FindBy(xpath="//div[@data-aid='patient-gender-selected-FEMALE']")
	...
	public void userDetails(String name,String age,String email) {
		...
		waitUntilWebElementIsVisible(patientGender);
		patientGender.click();
