...
public class Story4 {
  ...
  public void f() throws InterruptedException, AWTException {
	  WebDriverManager.chromedriver().setup();  
		...
		driver.findElement(By.cssSelector("#Name-AIlment-Lead-Form")).sendKeys("Ma");
		...
		driver.findElement(By.cssSelector(".ailmentLeadForm-module_submit-cta__oKug8")).click();
		
		boolean condition = driver.findElement(By.xpath("//p[text()='Get FREE consultation with Practo Care surgical specialist']")).isDisplayed();
